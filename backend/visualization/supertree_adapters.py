...
if TYPE_CHECKING:
    from backend.rules.schema import Rule, DecisionBranch, DecisionLeaf
...
def build_ontology_tree() -> dict:
    ...
    from backend.ontology.types import ActorType, InstrumentType, ActivityType, ProvisionType
...
def build_decision_tree_structure(node) -> dict | None:
    ...
    # Import here to avoid circular dependencies
    from backend.rules.schema import DecisionLeaf as SchemaLeaf, DecisionBranch
    from backend.rules.loader import DecisionLeaf as LoaderLeaf, DecisionNode
