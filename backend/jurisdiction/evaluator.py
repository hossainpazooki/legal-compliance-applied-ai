...
from backend.rules.engine import DecisionEngine
from backend.rules.loader import RuleLoader
from backend.compiler.premise_index import get_premise_index
...
def _get_rule_loader() -> RuleLoader:
    ...
    if _rule_loader is None:
        ...
        _rule_loader.load_directory("backend/rules")
    return _rule_loader
